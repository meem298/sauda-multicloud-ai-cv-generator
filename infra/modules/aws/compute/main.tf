...
resource "aws_ecs_task_definition" "backend" {
  ...
  container_definitions = jsonencode([{
    ...
    environment = [
      ...
      { name = "PDF_BUCKET_NAME", value = var.pdf_bucket_name },
      { name = "DYNAMODB_TABLE_NAME", value = var.dynamodb_table_name },
      { name = "SESSIONS_TABLE_NAME", value = var.sessions_table_name }
    ]
    ...
    secrets = [
      ...
      {
        name      = "VERTEX_AI_KEY"
        valueFrom = var.vertex_ai_key_arn
      }
    ]
